...
def main():
    ...
    if choice == "Inicio":
        ...
        st.markdown(
            "#### A tu izquierda encontrarás varias secciones, en donde cada apartado tendrá una breve explicación")
    ...
    if choice == "Facebook Prophet":
        ...
        st.title("Modelos Predictivos de Facebook Prophet")
